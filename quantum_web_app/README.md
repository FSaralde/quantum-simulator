...
This folder also includes Vercel serverless API files in `api/`.
...
The Python file `backend.py` is for local/Render-style servers. On Vercel, the `/api/*.py` files are the backend.
